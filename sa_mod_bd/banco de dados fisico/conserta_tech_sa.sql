...
(1,1,'lucas.oliveira@email.com','Lucas Oliveira','Cliente novo','1990-04-10',NULL,'M'),
(2,2,'mariana.costa@email.com','Mariana Costa','Cliente com urgência em atendimento','1985-08-15',NULL,'F'),
(3,3,'joao.silva@email.com','João Silva','Solicitação de reparo em equipamento','1980-12-20',NULL,'M'),
(4,4,'ana.paula@email.com','Ana Paula','Pedido para serviço de manutenção','1992-03-25',NULL,'F'),
(5,5,'pedro.oliveira@email.com','Pedro Oliveira','Necessita de acompanhamento mensal','1995-02-18',NULL,'M'),
(6,6,'carla.souza@email.com','Carla Souza','Cliente com contrato de longo prazo','1988-11-30',NULL,'F'),
(7,7,'rafael.lima@email.com','Rafael Lima','Precisa de suporte técnico remoto','1991-07-22',NULL,'M'),
(8,8,'fernanda.rocha@email.com','Fernanda Rocha','Cliente com necessidades especiais','1993-06-10',NULL,'F'),
(9,9,'diego.mendes@email.com','Diego Mendes','Agendamento de visita técnica','1987-09-04',NULL,'M'),
(10,10,'juliana.martins@email.com','Juliana Martins','Cliente com visita mensal programada','1990-05-17',NULL,'F'),
(11,11,'gustavo.alves@email.com','Gustavo Alves','Solicitação de instalação de sistema','1986-02-05',NULL,'M'),
(12,12,'camila.pires@email.com','Camila Pires','Serviço de instalação pendente','1994-01-29',NULL,'F'),
(13,13,'andre.reis@email.com','André Reis','Cliente precisa de serviço urgente','1982-10-15',NULL,'M'),
(14,14,'patricia.teixeira@email.com','Patrícia Teixeira','Pedido de reparo rápido','1990-08-12',NULL,'F'),
(15,15,'bruno.nascimento@email.com','Bruno Nascimento','Solicitação de serviço de emergência','1989-11-23',NULL,'M'),
(16,16,'laura.gomes@email.com','Laura Gomes','Aguardando peças para reparo','1991-06-09',NULL,'F'),
(17,17,'fabio.cunha@email.com','Fábio Cunha','Cliente com histórico de bons pagamentos','1985-03-27',NULL,'M'),
(18,18,'livia.fernandes@email.com','Lívia Fernandes','Necessita de suporte técnico mensal','1992-05-20',NULL,'F'),
(19,19,'eduardo.batista@email.com','Eduardo Batista','Agendamento de visita técnica','1993-04-03',NULL,'M'),
(20,20,'renata.lima@email.com','Renata Lima','Cliente com necessidades específicas','1991-08-11',NULL,'F'),
(21,1,'marcelo.torres@email.com','Marcelo Torres','Cliente com contrato de longo prazo','1988-09-22',NULL,'M'),
(22,2,'elaine.barbosa@email.com','Elaine Barbosa','Precisa de reparo urgente','1995-12-15',NULL,'F'),
(23,3,'cesar.martins@email.com','César Martins','Agendamento de serviço técnico','1983-11-30',NULL,'M'),
(24,4,'tatiane.prado@email.com','Tatiane Prado','Cliente com pendência de pagamento','1990-10-05',NULL,'F'),
(25,5,'paulo.lima@email.com','Paulo Lima','Necessita de manutenção preventiva','1994-03-18',NULL,'M'),
(26,6,'debora.castro@email.com','Débora Castro','Aguardando confirmação de visita','1987-05-29',NULL,'F'),
(27,7,'roberto.lopes@email.com','Roberto Lopes','Cliente com problemas recorrentes','1991-02-12',NULL,'M'),
(28,8,'sandra.ribeiro@email.com','Sandra Ribeiro','Aguardando peça para reparo','1984-08-10',NULL,'F'),
(29,9,'vinicius.dias@email.com','Vinícius Dias','Visita técnica agendada','1990-04-03',NULL,'M'),
(30,10,'simone.neves@email.com','Simone Neves','Necessita de suporte técnico remoto','1992-11-13',NULL,'F'),
(31,11,'murilo.carvalho@email.com','Murilo Carvalho','Cliente com necessidade de manutenção urgente','1985-06-21',NULL,'M'),
(32,12,'leticia.moura@email.com','Letícia Moura','Aguardando orçamento','1994-01-10',NULL,'F'),
(33,13,'alex.costa@email.com','Alex Costa','Precisa de peças para reparo','1987-09-18',NULL,'M'),
(34,14,'daniela.silva@email.com','Daniela Silva','Solicitação de instalação de equipamentos','1991-02-20',NULL,'F'),
(35,15,'rodrigo.cunha@email.com','Rodrigo Cunha','Precisa de manutenção preventiva','1986-03-10',NULL,'M'),
(36,16,'isabela.souza@email.com','Isabela Souza','Cliente com necessidade de atendimento remoto','1990-07-17',NULL,'F'),
(37,17,'thiago.rocha@email.com','Thiago Rocha','Aguardando serviço de reparo','1988-01-25',NULL,'M'),
(38,18,'priscila.fernandes@email.com','Priscila Fernandes','Solicitação de revisão do sistema','1992-11-06',NULL,'F'),
(39,19,'luciano.ramos@email.com','Luciano Ramos','Cliente com histórico de pagamentos rápidos','1989-07-28',NULL,'M'),
(40,20,'adriana.lima@email.com','Adriana Lima','Reparo pendente para o equipamento','1994-02-09',NULL,'F'),
(41,21,'fernando.monteiro@email.com','Fernando Monteiro','Cliente com urgência para revisão','1982-09-16',NULL,'M'),
(42,22,'cristina.sales@email.com','Cristina Sales','Necessita de manutenção mensal','1993-10-05',NULL,'F'),
(43,23,'igor.azevedo@email.com','Igor Azevedo','Aguardando entrega de peças','1985-01-17',NULL,'M'),
(44,24,'bianca.almeida@email.com','Bianca Almeida','Serviço técnico agendado','1991-03-02',NULL,'F'),
(45,25,'hugo.teixeira@email.com','Hugo Teixeira','Precisa de ajuda para instalação','1986-06-14',NULL,'M'),
(46,26,'marta.assis@email.com','Marta Assis','Cliente com contrato em andamento','1992-12-25',NULL,'F'),
(47,27,'sergio.castro@email.com','Sérgio Castro','Aguardando visita técnica para revisão','1988-05-06',NULL,'M'),
(48,28,'aline.barbosa@email.com','Aline Barbosa','Necessita de manutenção corretiva','1994-09-11',NULL,'F'),
(49,29,'danilo.pereira@email.com','Danilo Pereira','Reparo necessário para equipamento principal','1990-11-23',NULL,'M'),
(50,30,'silvia.faria@email.com','Silvia Faria','Cliente aguardando instalação de sistema','1987-05-14',NULL,'F'),
(51,31,'antonio.rocha@email.com','Antônio Rocha','Aguardando aprovação de orçamento','1992-07-20',NULL,'M'),
(52,32,'beatriz.alves@email.com','Beatriz Alves','Cliente com assistência técnica programada','1989-12-12',NULL,'F'),
(53,33,'cristiano.viana@email.com','Cristiano Viana','Serviço técnico agendado','1987-04-02',NULL,'M'),
(54,34,'daniela.dias@email.com','Daniela Dias','Precisa de serviço de reparo imediato','1992-10-19',NULL,'F'),
(55,35,'marcela.gomes@email.com','Marcela Gomes','Cliente com solicitação de manutenção','1993-06-30',NULL,'F'),
(56,36,'carlos.silva@email.com','Carlos Silva','Precisa de revisão e ajustes no equipamento','1989-09-05',NULL,'M'),
(57,37,'elaine.souza@email.com','Elaine Souza','Aguardando peça para troca','1990-02-28',NULL,'F'),
(58,38,'fabio.rocha@email.com','Fábio Rocha','Necessita de agendamento de manutenção','1987-07-19',NULL,'M'),
(59,39,'amanda.teixeira@email.com','Amanda Teixeira','Reparo solicitado para equipamentos','1994-01-11',NULL,'F'),
(60,40,'julio.cesar@email.com','Julio César','Precisa de revisão do sistema','1989-04-23',NULL,'M');
