...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (
        ...
        if ($stmt->execute()) {
            // Redireciona para buscar_cliente.php passando mensagem via GET
                    ...
                    <div class="campos_juridica">
                        <div class="linha">
                            ...
                            <input type="text" id="nome_cliente" name="nome" class="form-control"
                                value="<?= safe_html($clienteAtual['nome'] ?? '') ?>" required>
                        </div>

                        <div class="linha">
                            <label for="email">Email:</label>
                            <input type="email" id="email" name="email" class="form-control"
                                value="<?= safe_html($clienteAtual['email'] ?? '') ?>" required>
                        </div>
                    ...
                    <div class="campos_juridica">
                        <div class="linha" style="grid-column: 1 / -1;">
                            ...
                            <textarea id="observacao" name="observacao" class="form-control"
                                rows="3"><?= safe_html($clienteAtual['observacao'] ?? '') ?></textarea>
                        </div>
                    </div>
                </div>
