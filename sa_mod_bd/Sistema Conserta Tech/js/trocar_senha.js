...
function conferirCampos() {
    ...
    var senha = document.getElementById('senha_nova') //Cria a varivael senha e puxa seu Id
    ...
    if (!email || email.value.trim() === "")  { //Se a variavel nome não existir (! garante isso), OU, se o valor digitado, sem contar os espaços for vazio
        notyf.error('Campo de email é deve ser preenchido!');   //Exibe a mensagem de erro pois o campo está vazio
