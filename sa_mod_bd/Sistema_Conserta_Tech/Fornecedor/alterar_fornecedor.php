...
if (isset($_GET['excluir_fornecedor'])) {
    try {
        ...
        if ($result['total'] > 0) {
            ...
            $_SESSION['tipo_mensagem'] = 'danger';
            header('Location: alterar_fornecedor.php?id=' . $id_fornecedor);
            exit;
        }
...
try {
    ...
    echo "Erro ao carregar fornecedor: " . $e->getMessage();
    exit;
}
...
<body>
    <?php if (isset($_SESSION['mensagem'])): ?>
        <div class="alert alert-<?= $_SESSION['tipo_mensagem'] ?> alert-dismissible fade show" style="position: fixed; top: 20px; right: 20px; z-index: 9999;">
            <?= $_SESSION['mensagem'] ?>
