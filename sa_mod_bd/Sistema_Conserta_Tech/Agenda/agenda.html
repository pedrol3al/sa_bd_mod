...
<head>
    ...
    <!-- Links dos css -->
    <link rel="stylesheet" href="css_agenda.css" />
    <link rel="stylesheet" href="../Menu_lateral/css-home-bar.css">

    <!-- Link do favicon e bootstrap -->
...
<body>
    ...
    <!-- Links para carregar o menu e carregar o javascript-->
    <script src="script_agenda.js" defer></script>
